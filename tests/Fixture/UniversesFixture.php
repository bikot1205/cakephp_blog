 ...
 *
 */
class UniversesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'characteristics' => ['type' => 'string', 'length' => 1, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'characteristics' => 'Lorem ipsum dolor sit ame',
            'created_at' => '2017-09-04 12:09:15',
            'updated_at' => '2017-09-04 12:09:15'
        ],
    ];
}
